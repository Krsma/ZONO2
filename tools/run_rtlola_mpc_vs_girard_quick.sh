...
REFERENCE_DIR="${PZR_REFERENCE_DIR:-$ROOT_DIR/results/rtlola-arm-mpc-variants-a143dd6-f587a0e-exact-metrics/references}"
...
export PZR_EVAL_TRACES="${PZR_EVAL_TRACES:-figure8,figure8_drift,random,random_violated,square,square_drift}"
